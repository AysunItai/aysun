...
import { PLACEMENT_TYPE_GOBLIN_ENEMY } from "../helpers/consts"; // Import PLACEMENT_TYPE_GOBLIN_ENEMY constant
...
export class GoblinEnemyPlacement extends RoamingEnemyPlacement {
  constructor(properties, level) {
    ...
    this.hp = 20; // Set initial HP
    this.gold = 5; // Set initial gold
    this.type = PLACEMENT_TYPE_GOBLIN_ENEMY; // Set placement type to PLACEMENT_TYPE_GOBLIN_ENEMY

    // Initialize current animation frames for both directions
