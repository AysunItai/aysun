...
import { useCharacterContext } from '../store/CharacterContext'; // Import the context hook
...
export class BatEnemyPlacement extends FlyingEnemyPlacement {
  ...
  renderComponent() {
    ...
    if (this.spriteFacingDirection === DIRECTION_LEFT) {
      switch (this.currentFrameLeft) {
        case 1:
          frameCoord = TILES.BAT_FLY_LEFT_1;
          break;
        case 2:
          frameCoord = TILES.BAT_FLY_LEFT_2;
          break;
        case 3:
          frameCoord = TILES.BAT_FLY_LEFT_3;
          break;
        default:
          break;
      }
      ...
      switch (this.currentFrameRight) {
        case 1:
          frameCoord = TILES.BAT_FLY_RIGHT_1;
          break;
        case 2:
          frameCoord = TILES.BAT_FLY_RIGHT_2;
          break;
        case 3:
          frameCoord = TILES.BAT_FLY_RIGHT_3;
          break;
        default:
          break;
      }
    ...
    return <BatEnemyBody frameCoord={frameCoord} showShadow={true} hp={this.hp} onAttack={this.onClick.bind(this)} />;
  }
}
