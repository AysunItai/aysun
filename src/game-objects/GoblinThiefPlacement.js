...
export class GoblinThiefPlacement extends RoamingEnemyPlacement {
  ...
  renderComponent() {
    ...
    return <GoblinEnemyBody frameCoord={frameCoord} showShadow={true} hp={this.hp} onClick={this.onClick} />;
  }
}
