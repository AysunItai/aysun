...
export const SPRITE_SHEET_ENEMY_SRC = "/32bats.png"
...
export const PLACEMENT_TYPE_BAT = "BAT";
export const PLACEMENT_TYPE_BAT_ENEMY = "BAT_ENEMY";
export const PLACEMENT_TYPE_GOBLIN = "GOBLIN_ENEMY";
export const PLACEMENT_TYPE_GOBLIN_THIEF = "GOBLIN_THIEF";
export const PLACEMENT_TYPE_STALKER_ENEMY = "STALKER_ENEMY";
export const PLACEMENT_TYPE_TREE = "TREE";
export const PLACEMENT_TYPE_BERRY = "BERRY";
